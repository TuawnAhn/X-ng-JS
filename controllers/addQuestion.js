        ...
        divElement.innerHTML =`
            ...
            <div class="answer_items mt-3">
                <div class="form-check fs-5 mb-3" >
                    <input class="form-check-input border border-2 border-primary" role="button" type="checkbox" name="question_${currentQuestion}" id="check_${currentQuestion}_1" >
                    <div class="mb-3">
                ...
                <div class="form-check fs-5 mb-3">
                    <input class="form-check-input border border-2 border-primary" role="button" type="checkbox" name="question_${currentQuestion}" id="check_${currentQuestion}_2" >
                    <div class="mb-3">
                ...
                <div class="form-check fs-5 mb-3">
                    <input class="form-check-input border border-2 border-primary" role="button" type="checkbox" name="question_${currentQuestion}" id="check_${currentQuestion}_3">
                    <!-- text answer -->
                    <div class="mb-3">
                ...
                <div class="form-check fs-5 mb-3">
                    <input class="form-check-input border border-2 border-primary" role="button" type="checkbox" name="question_${currentQuestion}" id="check_${currentQuestion}_4">
                    <!-- text answer -->
                    <div class="mb-3">
    ...
    handleSubmit : function (){
        document.getElementById('btn_submit').addEventListener('click',async()=>{
            ...
            for(var i =0; i < listData.length; i++){
                ...
                //2.2 lấy checkbox
                const checks = listData[i].querySelectorAll('input[type="checkbox"]')
